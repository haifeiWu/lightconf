                                ...
                                <#if list?exists && list?size gt 0>
                                    <#list list as app>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning btn-xs update" id="${app.id}"
                                                        appName="${app.appName}" appDesc="${app.appDesc}">编辑
                                                </button>
                                                <button class="btn btn-danger btn-xs remove" id="${app.id}">删除</button>
                                                <button class="btn btn-info btn-xs getAppConf" id="${app.id}">应用配置信息
                                                </button>
                                            </td>
                                        </tr>
                                    </#list>
                    ...
                    <form class="form-horizontal form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" name="appName"
                                                          placeholder="请输入“应用名”" maxlength="64"></div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">应用描述<font color="red">*</font></label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="appDesc"
                                                          placeholder="请输入“应用描述”" maxlength="12"></div>
                        </div>
                        <hr>
                        <div class="form-group">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form">
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">应用名<font color="red">*</font></label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="appName"
                                                          placeholder="请输入“应用名”" maxlength="64" readonly></div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">应用描述<font color="red">*</font></label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="appDesc"
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" name="id"
                                                          placeholder="请输入“appId”" maxlength="12"></div>
                        </div>
                        <hr>
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
